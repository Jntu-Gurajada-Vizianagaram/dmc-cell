        ...
        <div className="left-content">
          ...
          <p>JNTUGV Digital Monitoring Cell (DMC) Established to maintain and monitor the IT infrastructure of the University. 
              ...
              organizations' digital operations, overseeing the management, maintenance, and security of their digital infrastructure.
               Established with the primary objective of ensuring the efficient and secure functioning of digital systems, the DMC 
               undertakes the critical task of monitoring networks, servers, databases, and applications. By proactively identifying 
               and addressing issues, the DMC minimizes downtime and disruptions, thereby optimizing organizational efficiency.
                Moreover, the DMC is entrusted with implementing robust cybersecurity measures to safeguard against cyber threats 
                and ensure compliance with relevant regulations. Beyond security, the DMC spearheads digitization initiatives, 
                driving innovation and digital transformation across the organization. Through collaboration with various departments 
                and teams, the DMC provides essential support, training, and technical assistance, fostering a culture of digital 
                excellence and resilience within the organization.</p>
        </div>
